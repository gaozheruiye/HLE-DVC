...
example.genAux()
# partialProof_P_0 = example.genPartialProof() 这个代码里给出了rho = 4时的genPartialProof()
...
# example.ProveAll() # We measured the time overhead of Prove All using https://github.com/sunblaze-ucb/eVSS
